...
run() {
    ...
    # RUST_BACKTRACE=1 \
    # RUST_LOG=warn,hyperast_vcs_git::git=debug \
    # $exe \
...
# run graphhopper graphhopper f5f2b7765e6b392c5e8c7855986153af82cc1abe # not part of HyperAST eval
