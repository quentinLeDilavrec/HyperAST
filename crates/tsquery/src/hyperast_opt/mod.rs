...
//     use super::no_opt::Node;
//     use super::no_opt::NodeR;
//     use super::no_opt::Pos;
//     use super::no_opt::TreeCursor;
//     use super::*;

//     impl<'hast, HAST: HyperAST> SimpleNode for Node<'hast, HAST> {
//         fn id(&self) -> usize {
//             todo!()
//         }
...
//     impl<'hast, HAST: HyperAST> SyntaxNode for Node<'hast, HAST> {
//         fn kind(&self) -> &'static str {
//             todo!()
//         }
...
//     impl<'hast, HAST: HyperAST> SyntaxNodeExt for Node<'hast, HAST> {
//         type Cursor = TreeCursor<'hast, HAST>;
...
//     pub struct QueryMatcher<'hast, HAST> {
//         pub query: crate::Query,
//         _phantom: std::marker::PhantomData<&'hast HAST>,
//     }
//     impl<'hast, HAST> tree_sitter_graph::QueryWithLang for QueryMatcher<'hast, HAST> {
//         type Lang = tree_sitter::Language;
//         type I = CaptureId;
//     }

//     impl<'a, 'hast, HAST> graph::NodeLending<'a> for QueryMatcher<'hast, HAST>
//     where
//         HAST: HyperAST,
//     {
...
//     impl<'a, 'hast, HAST> tree_sitter_graph::MatchesLending<'a> for QueryMatcher<'hast, HAST>
//     where
//         HAST: HyperAST,
//     {
...
//     impl<'hast, HAST> tree_sitter_graph::GenQuery for QueryMatcher<'hast, HAST>
//     where
//         HAST: HyperAST + Copy,
//         HAST::IdN: Debug + Copy + Hash,
//     {
...
//     pub struct MyQMatches<'query, 'hast, It, HAST: HyperASTShared> {
//         q: &'query QueryMatcher<'hast, HAST>,
//         matchs: It,
//         node: Node<'hast, HAST>,
//     }

//     impl<'a, 'query, 'hast, It, HAST: HyperAST> QueryWithLang for MyQMatches<'query, 'hast, It, HAST> {
//         type Lang = tree_sitter::Language;
//         type I = CaptureId;
//     }

//     impl<'a, 'query, 'hast, It, HAST: HyperAST> MatchLending<'a>
//         for MyQMatches<'query, 'hast, It, HAST>
//     {
//         type Match = MyQMatch<'hast, HAST>;
//     }

//     impl<'query, 'hast, It, HAST: HyperAST> MatchLender for MyQMatches<'query, 'hast, It, HAST> {
//         fn next(&mut self) -> Option<<Self as MatchLending<'_>>::Match> {
//             todo!()
//         }
//     }

//     pub struct MyQMatch<'hast, HAST: HyperAST, P = Pos<HAST>> {
//         stores: &'hast HAST,
//         qm: crate::QueryMatch<Node<'hast, HAST, P>>,
//         i: u16,
//     }

//     impl<'a, 'hast, HAST: HyperAST> QueryWithLang for MyQMatch<'hast, HAST, Pos<HAST>> {
//         type Lang = tree_sitter::Language;
//         type I = CaptureId;
//     }

//     impl<'a, 'hast, HAST: HyperAST> graph::NodesLending<'a> for MyQMatch<'hast, HAST, Pos<HAST>> {
//         type Nodes = CapturedNodesIter<'hast, 'a, HAST, Pos<HAST>>;
//     }

//     impl<'hast, HAST: HyperAST> graph::QMatch for MyQMatch<'hast, HAST, Pos<HAST>> {
...
//     pub struct CapturedNodesIter<'hast, 'x, HAST: HyperASTShared, P = Pos<HAST>> {
//         stores: &'hast HAST,
//         index: CaptureId,
//         inner: &'x [crate::Capture<Node<'hast, HAST, P>>],
//     }

//     impl<'a, HAST: HyperAST> NodeLending<'a> for CapturedNodesIter<'_, '_, HAST> {
//         type SNode = Node<'a, HAST>;
//     }

//     impl<HAST: HyperAST> graph::NodeLender for CapturedNodesIter<'_, '_, HAST> {
//         fn next(&mut self) -> Option<<Self as NodeLending<'_>>::SNode> {
//             todo!()
//         }
//     }
...
//     impl<'hast, HAST> tree_sitter_graph::ExtendedableQuery
//         for ExtendingStringQuery<QueryMatcher<'hast, HAST>, tree_sitter::Language>
//     where
//         HAST: HyperAST + Copy,
//         HAST::IdN: Copy + Hash + Debug,
//         // HAST::Idx: Copy + Hash,
//         // for<'t> LendT<'t, HAST>: WithSerialization + WithStats + WithRoles,
//         // HAST::TS: types::RoleStore<IdF = IdF, Role = types::Role>,
//         // HAST::IdN: types::NodeId<IdN = HAST::IdN>,
//     {
//         type Query = QueryMatcher<'hast, HAST>;
//         type Lang = tree_sitter::Language;
