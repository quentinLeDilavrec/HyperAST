...
pub type TreeCursor<HAST: HyperASTShared> =
    super::TreeCursorNoRef<HAST, PersistCursor<HAST::IdN, HAST::Idx>>;
...
impl<'a, HAST: HyperAST + Copy> crate::CNLending<'a> for TreeCursor<HAST>
where
...
{
    type NR = super::NodeRefNoRef<'a, HAST>;
}

impl<'a, HAST: HyperAST> crate::StatusLending<'a> for TreeCursor<HAST>
where
    HAST::TS: RoleStore,
{
...
impl<HAST: HyperAST + Copy> crate::Cursor for TreeCursor<HAST>
where
    HAST::IdN: std::fmt::Debug + Copy,
    HAST::TS: RoleStore,
    for<'t> LendT<'t, HAST>: WithRoles,
    ...
    HAST::IdN: NodeId<IdN = HAST::IdN>,
{
    type Node = super::NodeNoRef<HAST, PersistCursor<HAST::IdN, HAST::Idx>>;
...
// impl<HAST: HyperAST + Copy, MiscS: Copy> structural_pos::CursorHead<HAST::IdN, HAST::Idx>
//     for PersistCursor<HAST, MiscS>
// where
//     HAST::IdN: Copy,
//     HAST::Idx: Copy,
// {
