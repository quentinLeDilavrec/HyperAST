...
use super::cursor_utils2::{goto_first_child_internal, goto_next_sibling_internal, goto_parent};
    ...
    HAST::IdN: hyperast::types::NodeId<IdN = HAST::IdN>,
{
    ...
    fn goto_next_sibling_internal(&mut self) -> TreeCursorStep {
        ...
        let r = goto_next_sibling_internal(self.stores, &mut self.pos.pos);
    ...
    fn goto_first_child_internal(&mut self) -> TreeCursorStep {
        let r = goto_first_child_internal(self.stores, &mut self.pos.pos);
        self.pos.n = self.stores.node_store().resolve(&self.pos.pos.node());
        r
    }
    ...
    fn goto_parent(&mut self) -> bool {
        ...
        let r = goto_parent(self.stores, &mut self.pos.pos);
        self.pos.n = self.stores.node_store().resolve(&self.pos.pos.node());
        r
    }
