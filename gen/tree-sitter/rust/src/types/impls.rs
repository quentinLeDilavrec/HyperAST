...
impl Lang {
    pub const NAME: &'static str = "hyperast_gen_ts_rust::types::Lang";
...
impl HyperType for Type {
    ...
    fn as_shared(&self) -> hyperast::types::Shared {
        ...
        match self {
            Type::Type => Shared::TypeDeclaration,
            Type::Struct => Shared::TypeDeclaration,
            Type::Trait => Shared::TypeDeclaration,
            Type::GenericFunction => Shared::TypeDeclaration,
